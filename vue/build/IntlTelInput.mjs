...
class q {
  ...
  _sortCountries() {
    this.options.countryOrder && (this.options.countryOrder = this.options.countryOrder.map((e) => e.toLowerCase())), this.countries.sort((e, t) => {
      ...
      if (i) {
        const s = i.indexOf(e.iso2), n = i.indexOf(t.iso2), o = s > -1, r = n > -1;
        if (o || r)
      ...
      if (t.areaCodes) {
        ...
        for (let s = 0; s < t.areaCodes.length; s++) {
          ...
          for (let o = 1; o < n.length; o++) {
            const r = n.substr(0, o), a = t.dialCode + r;
            this._addToDialCodeMap(i, a), this._addToDialCodeMap(t.iso2, a);
          }
  ...
  _generateMarkup() {
    ...
    let C = "iti";
    e && (C += " iti--allow-dropdown"), i && (C += " iti--show-flags"), s && (C += ` ${s}`), a || (C += " iti--inline-dropdown");
    const p = y("div", { class: C });
    if ((h = this.telInput.parentNode) == null || h.insertBefore(p, this.telInput), e || i || t) {
  ...
  _appendListItems() {
    for (let e = 0; e < this.countries.length; e++) {
      ...
      let o = "";
      this.options.showFlags && (o += `<div class='iti__flag iti__${t.iso2}'></div>`), o += `<span class='iti__country-name'>${t.name}</span>`, o += `<span class='iti__dial-code'>+${t.dialCode}</span>`, n.insertAdjacentHTML("beforeend", o);
    }
  }
  ...
  _setInitialState(e = !1) {
    const t = this.telInput.getAttribute("value"), i = this.telInput.value, n = t && t.charAt(0) === "+" && (!i || i.charAt(0) !== "+") ? t : i, o = this._getDialCode(n), r = S(n), { initialCountry: a, geoIpLookup: c } = this.options, d = a === "auto" && c;
    if (o && !r)
  ...
  _initDropdownListeners() {
    ...
    e && e.addEventListener("click", this._handleLabelClick), this._handleClickSelectedCountry = () => {
      ...
      i && ["ArrowUp", "ArrowDown", " ", "Enter"].includes(t.key) && (t.preventDefault(), t.stopPropagation(), this._openDropdown()), !i && t.key === "Enter" && (t.preventDefault(), t.stopPropagation(), this._handleEnterKey()), t.key === "Tab" && this._closeDropdown();
  ...
  _initTelInputListeners() {
    ...
    new RegExp("\\p{L}", "u").test(this.telInput.value) && (r = !0), this._handleInputEvent = (a) => {
      ...
      c || d && !e ? r = !0 : /[^+0-9]/.test(this.telInput.value) || (r = !1);
    ...
    }, this.telInput.addEventListener("input", this._handleInputEvent), (e || i) && (this._handleKeydownEvent = (a) => {
  ...
  _filterCountries(e, t = !1) {
    ...
    for (let n = 0; n < this.countries.length; n++) {
      ...
      if (t || r.includes(s) || c.includes(s) || o.iso2.includes(s) || a.includes(s)) {
  ...
  _setCountry(e) {
    ...
    if (this.selectedCountryData = e ? this._getCountryData(e, !1) || {} : {}, this.selectedCountryData.iso2 && (this.defaultCountry = this.selectedCountryData.iso2), this.selectedCountryInner) {
      let o = "", r = "";
      if (e && i ? (o = `iti__flag iti__${e}`, r = `${this.selectedCountryData.name} +${this.selectedCountryData.dialCode}`) : (o = "iti__flag iti__globe", r = s.noCountrySelected), this.selectedCountryInner.className = o, this.selectedCountryA11yText.textContent = r, !navigator.userAgent.match(/Firefox/)) {
        const a = document.querySelector("#screen-reader-announcements");
        a && (a.innerHTML = r);
      }
    }
  ...
  _selectListItem(e) {
    const t = document.querySelector("#screen-reader-announcements");
    t && (t.innerHTML = "");
    const i = this._setCountry(
      e.getAttribute("data-country-code")
    );
    this._closeDropdown(), this._updateDialCode(e.getAttribute("data-dial-code")), this.telInput.focus(), i && (this._triggerCountryChange(), navigator.userAgent.match(/Firefox/) || t && (t.innerHTML = this.selectedCountry.getAttribute("title")));
  }
  ...
  _scrollTo(e) {
    const t = this.countryList, i = document.documentElement.scrollTop, s = t.offsetHeight, n = t.getBoundingClientRect().top + i, o = n + s, r = e.offsetHeight, a = e.getBoundingClientRect().top + i, c = a + r, d = a - n + t.scrollTop;
    if (a < n)
      t.scrollTop = d;
    else if (c > o) {
      const C = s - r;
...
const G = (u) => {
  ...
  setup(u, { expose: e, emit: t }) {
    const i = x(u, "modelValue"), s = u, n = t, o = L(), r = L(), a = L(!1), c = () => r.value ? s.options.strictMode ? r.value.isValidNumberPrecise() : r.value.isValidNumber() : null, d = () => {
      let h = c();
    ...
    }), e({ instance: r, input: o }), (h, m) => B((V(), R("input", z({
      ref_key: "input",
      ref: o,
